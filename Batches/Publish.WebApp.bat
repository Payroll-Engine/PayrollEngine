...
echo.
echo ----------------- Payroll WebApp -----------------
dotnet publish %~dp0..\..\PayrollEngine.WebApp\Client\PayrollEngine.WebApp.Client.csproj --self-contained %PUB_SELF_CONTAINED% --output %~dp0..\Bin\PayrollEngine.WebApp --configuration Release
